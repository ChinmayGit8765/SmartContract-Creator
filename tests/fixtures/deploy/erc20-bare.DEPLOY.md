...
No centralization warnings for this option combination.
...
5. In the **Deploy & Run** tab, choose your environment (Injected Provider — MetaMask), enter the constructor arguments (recipient), and click **Deploy**
...
forge verify-contract <DEPLOYED_ADDRESS> src/MyToken.sol:MyToken \
  --constructor-args $(cast abi-encode "constructor(address)" <YOUR_WALLET_ADDRESS>) \
...
npx hardhat verify --network <NETWORK_NAME> <DEPLOYED_ADDRESS> "<YOUR_WALLET_ADDRESS>"
```
