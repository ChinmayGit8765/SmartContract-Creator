...
2. In the File Explorer, create a new file named `MyNFT.sol`
3. Paste the contents of your generated `MyNFT.sol` into it
4. In the **Solidity Compiler** tab, select compiler 0.8.35 and click "Compile MyNFT.sol"
...
forge verify-contract <DEPLOYED_ADDRESS> src/MyNFT.sol:MyNFT \
